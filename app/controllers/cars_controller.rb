...
class CarsController < ApplicationController
  ...
  def car_params
    # params.require(:car).permit(:carmodel, :brand, :year, :body, :price, :user_id, :status) # without status
    # params.require(:car).permit(:brand, :carmodel, :year, :body, :price, :status) # wihout user_id & status
